...
public class TestFixedWidth {
    ...
    private static void runTest(CSVConfiguration cfg, BonaPortable input, String expectedOutput) throws MessageParserException {
        runTest(cfg, input, expectedOutput, true);
    }

    private static void runTest(CSVConfiguration cfg, BonaPortable input, String expectedOutput, boolean checkDeserialize) throws MessageParserException {
...
//        System.out.println("Result is " + actualOutput);
    ...
    @Test
    public void testFixedWidthWithTruncatedString() throws Exception {
        Test1 t1 = new Test1("Hello large World", 12, new BigDecimal("3.1"), LocalDateTime.of(2013, 04, 01, 23, 55, 0), LocalDate.of(2001, 11, 12), true, 1234567890123L);

        runTest(fixedWidthCfg1, t1, "Hello larg 0000000012000000000003.10 201304012355002001111210000001234567890123\n", false);
    }
