...
public class FoldingByteArrayComposer<E extends Exception> implements BufferedMessageComposer<E> {
    private static final Logger LOGGER = LoggerFactory.getLogger(FoldingByteArrayComposer.class);
    ...
    FoldingByteArrayComposer(BufferedMessageComposer<E> delegateComposer, Map<Class<? extends BonaPortable>, List<String>> mapping, FoldingStrategy errorStrategy) {
