...
public interface StringConverter {
    ...
    String convert(String oldValue, int maxLength, boolean isRequired);
    ...
    List <String> convertList(List<String> oldList, int maxElementLength, int maxElements, boolean isRequired);
    ...
    String [] convertArray(String [] oldArray, int maxElementLength, int maxElements, boolean isRequired);
